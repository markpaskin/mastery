...
public class SliderPreference extends DialogPreference {
    ...
    protected CharSequence getSummaryForCurValue() {
        if (mSummaries != null && mSummaries.length > 0) {
            int index = (int) (getCurValueFromSeekBar() * mSummaries.length);
    ...
    float getCurValueFromSeekBar() {
        return (float) mSeekBarValue / SEEKBAR_RESOLUTION;
    }
    ...
    protected View onCreateDialogView() {
        ...
        summaryTextView = (TextView) view.findViewById(R.id.slider_preference_summary);
        seekbar.setMax(SEEKBAR_RESOLUTION);
        seekbar.setProgress(mSeekBarValue);
        summaryTextView.setText(getSummaryForCurValue());
